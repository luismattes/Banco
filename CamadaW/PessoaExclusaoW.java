...
import CamadaS.PessoaExclusaoS;
 ...
 * @author Luis
 */
public class PessoaExclusaoW extends javax.swing.JFrame {
    private final PessoaExclusaoS controlador;
    /**
     * Creates new form ExclusaoW
     */
    public PessoaExclusaoW() {
        initComponents();
        controlador = new PessoaExclusaoS(this);
    }
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(45, 45, 45)
                        .addComponent(jTextFieldCpfCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(146, 146, 146)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PessoaExclusaoW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PessoaExclusaoW().setVisible(true);
            }
        });
    }
